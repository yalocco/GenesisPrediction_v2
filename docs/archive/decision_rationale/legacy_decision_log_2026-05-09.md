...
Status: Archive
Created: 2026-05-09
Source: docs/core/decision_log.md before consolidation
Original line count: 3866
Purpose: Preserve historical rationale, operational explanation, and long-form context removed from the compact authoritative decision_log.md.

---

# Archive Boundary

This file is not the authoritative operational decision record.

Authoritative current decisions live in:
...
This archive may be used for rationale lookup, audit, and historical reconstruction only.
